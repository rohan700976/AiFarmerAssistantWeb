...
export default function ForgotPassword() {
  ...
  const handleRequestReset = async (e) => {
    ...
    try {
      ...
      setResetToken(res.data.resetToken); // For dev; remove in prod
      setStep(2);
    } catch (err) {
      setMessage(err.response?.data.message || 'Error requesting reset');
    }
  };
      ...
      <div className="relative py-3 w-[420px] sm:mx-auto mt-4">
        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div className="max-w-md mx-auto">
            ...
            <form onSubmit={step === 1 ? handleRequestReset : handleReset}>
